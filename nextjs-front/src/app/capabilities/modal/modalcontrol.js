      ...
      <div id='modal' className={isActive ? "modal-active" : "modal-desactive"}>
              ...
              <div id='container-parraf'>
                ...
                <div className='m-0'>
                    ...
                    <p className='md:text-3xl text-2xl text-justify max-sm:m-0 m-5'>Skilled in utilizing GIT, SVN, and CVS for efficient code version management
                    </p>
                  </div>
                  </div>
              </div>
