  ...
  return (
    ...
    {/* Button Modal */}
      ...
      <div id='modal' className={isActive ? "modal-active" : "modal-desactive"}>
                ...
                <h5 className="w-[35%] text-center m-0 text-3xl hover:text-[#12487E]">
                      Languages<b>/</b>Frameworks
                    </h5>

                    <button className="w-[10%] hover:scale-110 p-0 m-0" onClick={() => setIsActive(!isActive)}>
                ...
                <div  id='container-parraf'>
                    <div className='m-0'>
                      ...
                      ºExpertise in Spring Boot fot both RESTful and SOAP-based APIs<i className='text-4xl'>.</i> <br/>
                      ºProficiency in Hibernate for steamlined database operations<i className='text-4xl'>.</i><br/>
                      ºMastery of deploying applications on Tomcat and WebLogic servers<i className='text-4xl'>.</i><br/>
                      </p>
                    </div>
                  </div>
                </div>
