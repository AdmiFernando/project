...
export default function ProjectWindows() {
  ...
  return (
    <>
      ...
      <h5 className="w-[83%] max-sm:w-[70%] max-sm:m-4  text-center m-0 text-3xl tracking-widest font-thin hover:text-[#1F803F]">
      Project Magnagement
      </h5>

      <button className="w-[12%] max-sm:w-[100%] max-sm:m-3  hover:scale-125  m- p-0 font-bold" onClick={()=>setIsopen(true)}>
              ...
              <div className='flex flex-row items-center gap-0 text-white'>
                ...
                <div className='m-5 flex flex-col w-[80%] justify-center'>
                  <div className='m-2'>
                    ...
                    <h6 className='text-3xl text-justify max-sm:m-0 m-3'>
