...
export default function ProjectWindows() {
  ...
  return (
    <>
      ...
      <h5 className="w-[83%] max-sm:w-[60%] max-sm:m-4  text-center m-0 md:text-3xl text-2xl tracking-widest font-thin hover:text-[#1F803F]">
      Project Magnagement
      </h5>

      <button className="w-[12%] max-sm:w-[15%]  hover:scale-125  m- p-0 font-bold" onClick={()=>setIsopen(true)}>
                ...
                <div className='m-5 flex flex-col w-[80%] justify-center'>
                  <div className='m-2'>
                    ...
                    <p className='md:text-3xl text-2xl text-justify max-sm:m-0 m-5'>
                      ºDiligent planning <br/><br/>
                      ºThorough analisys <br/><br/>
                      ºMeticulous design <br/><br/>
                      ºPrecise execution <br/><br/>
                    </p>
                  </div>
                  </div>
              </div>
