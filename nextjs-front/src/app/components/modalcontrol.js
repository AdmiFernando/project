  ...
  return (
    <>
      <div className='flex flex-row justify-center items-center text-white'>
        ...
        <button className="w-[12%] max-sm:w-[15%] hover:scale-125  m-0 p-0 font-bold" onClick={()=>setIsopen(true)}>
      ...
      {
        isopen && (
          <div className="inset-0 absolute backdrop-blur-sm flex justify-center items-center max-sm:w-[100%]">
            ...
            <div className="bg-[#062132] text-white flex flex-col items-center p-5 rounded w-full h-full max-sm:w-[100%] ">
              ...
              <div className='flex flex-row items-center gap-0 text-white'>
                ...
                <button className="w-[4%] max-sm:w-[15%] hover:scale-125  m- p-0 font-bold" onClick={()=>setIsopen(false)}>
