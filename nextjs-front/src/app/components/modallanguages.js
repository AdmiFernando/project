  ...
  return (
    <>
      <div className='flex flex-row justify-center items-center text-white'>
        ...
        <h5 className="w-[73%] max-sm:w-[80%]  text-center m-0 text-3xl tracking-widest font-thin hover:text-[#1F803F]">
              ...
              <div className='flex flex-row items-center gap-0 text-white'>
                ...
                <div className='m-5 flex flex-col justify-center'>
                  <div className='m-2'>
                    ...
                    <h6 className='text-3xl text-justify m-3'>
                      JAVA:
                    </h6>
                    <p className='text-2xl text-justify max-sm:m-0 m-5'>
