...
export default function LanguaguesWindows() {
  ...
  return (
    <>
      <div className='flex flex-row justify-center items-center text-white'>
        ...
        <h5 className="w-[73%] max-sm:w-[55%] text-center m-0 md:text-3xl text-2xl tracking-widest font-thin hover:text-[#1F803F]">
          Languages<b>/</b> Frameworks
        </h5>
        ...
        
      {
        isopen && (
          <div className="inset-0 absolute backdrop-blur-sm flex justify-center items-center max-sm:w-[100%] max-sm:h-[100%]">
            ...
            <div className="bg-[#062132] text-white flex flex-col items-center p-5 rounded w-full h-[100%] max-sm:w-[100vh]">
            ...
            <div className='flex flex-row max-sm:flex-col'>
              ...
              <div className='flex flex-row items-center gap-0 text-white'>
                  ...
                  <h5 className="w-[50%] max-sm:w-[80%] text-center m-0 md:text-3xl text-2xl tracking-widest font-thin hover:text-[#1F803F]">
                    Languages<b>/</b> Frameworks
                  </h5>

                  <button className="w-[5%] max-sm:w-[15%] hover:scale-125  m-0 p-0 font-bold" onClick={()=>setIsopen(false)}>
                ...
                <div className='m-5 flex flex-col justify-center'>
                  <div className='m-2'>
                    ...
                    ºExpertise in Spring Boot fot both RESTful and SOAP-based APIs<i className='text-4xl'>.</i> <br/><br/>
                    ºProficiency in Hibernate for steamlined database operations<i className='text-4xl'>.</i> <br/><br/>
                    ºMastery of deploying applications on Tomcat and WebLogic servers<i className='text-4xl'>.</i> <br/><br/>
                    </p>
                  </div>
                  </div>
              </div>
